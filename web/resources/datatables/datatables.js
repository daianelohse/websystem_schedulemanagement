    ...
    var S = function(h) {
        ...
        function pb(a) {
            var b = a.oClasses,
                ...
                e = a.oPreviousSearch,
                f = a.aanFeatures,
                g = '<input type="search"><i class="material-icons prefix">search</i></input>',
                i = d.sSearch,
        ...
        function ob(a) {
            for (var b = a.oClasses, c = a.sTableId, d = a.aLengthMenu, e = h.isArray(d[0]), f = e ? d[0] : d, d = e ? d[1] : d, e = h("<select class=\"browser-default\"/>", {
                    name: c + "_length",
                    "aria-controls": c,
